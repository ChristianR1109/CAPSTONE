...
public class TeamsRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<Team> teams2026 = List.of(
                ...
                new Team("Cagliari", 0, 0, 0, 0, 0, 0, 0, 0, 0),
                new Team("Como", 0, 0, 0, 0, 0, 0, 0, 0, 0),
                new Team("Cremonese", 0, 0, 0, 0, 0, 0, 0, 0, 0),
                new Team("Fiorentina", 0, 0, 0, 0, 0, 0, 0, 0, 0),
                new Team("Genoa", 0, 0, 0, 0, 0, 0, 0, 0, 0),
                ...
                new Team("Milan", 0, 0, 0, 0, 0, 0, 0, 0, 0),
                new Team("Napoli", 0, 0, 0, 0, 0, 0, 0, 0, 0),
                new Team("Parma", 0, 0, 0, 0, 0, 0, 0, 0, 0),
                new Team("Pisa", 0, 0, 0, 0, 0, 0, 0, 0, 0),
