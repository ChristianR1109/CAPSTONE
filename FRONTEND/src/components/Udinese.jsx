...
const Udinese = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:1313/public/matches")
      ...
      .then((data) => {
        ...
        console.log(data);
        const squadraDesiderata = "Udinese";
  ...
  return (
    <div className="stripe-udinese" style={{ minHeight: "100vh", color: "white" }}>
      <Container fluid className="my-5" style={{ maxWidth: "600px" }}>
        <Card className="p-0 mb-4 border-dark border-2">
          <h1 className="text-center team-title m-0">Udinese Calcio</h1>
        </Card>
