...
const Lecce = () => {
  ...
  return (
    <div className="stripe-lecce" style={{ minHeight: "100vh", color: "white" }}>
      <Container fluid className="my-5" style={{ maxWidth: "600px" }}>
        <Card className="p-0 mb-4 border-dark border-2">
          <h1 className="text-center team-title m-0">Unione Sportiva Lecce</h1>
        </Card>
