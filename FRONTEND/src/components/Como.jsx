...
const Cremonese = () => {
  ...
  return (
    <>
      <div className="stripe-como" style={{ minHeight: "100vh", color: "white" }}>
              ...
              <Form onSubmit={handleSubmit}>
                <Form.Group className="mb-3" controlId="formMatch">
                  ...
                  <Form.Select
                    ...
                    required
                    style={{ backgroundColor: "#073F6A", color: "white", borderColor: "#ffffffff" }}
                  >
                ...
                <Button type="submit" variant="primary" style={{ backgroundColor: "#073F6A", borderColor: "white" }}>
                  Acquista
                </Button>
              </Form>
            </Card.Body>
