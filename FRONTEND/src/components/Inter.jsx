...
const Inter = () => {
  ...
  return (
    <>
      <div className="stripe-inter" style={{ minHeight: "100vh", color: "white" }}>
              ...
              <Form onSubmit={handleSubmit}>
                <Form.Group className="mb-3" controlId="formMatch">
                  ...
                  <Form.Select
                    ...
                    required
                    style={{ backgroundColor: "#001E9D", color: "white", borderColor: "#ffffffff" }}
                  >
                ...
                <Button type="submit" variant="primary" style={{ backgroundColor: "#001E9D", borderColor: "white" }}>
                  Acquista
                </Button>
              </Form>
            </Card.Body>
