...
const Fiorentina = () => {
  ...
  return (
    <>
      <div className="stripe-fiorentina" style={{ minHeight: "100vh", color: "white" }}>
              ...
              <Form onSubmit={handleSubmit}>
                <Form.Group className="mb-3" controlId="formMatch">
                  ...
                  <Form.Select
                    ...
                    required
                    style={{ backgroundColor: "#61328C", color: "white", borderColor: "#ffffffff" }}
                  >
                ...
                <Button type="submit" variant="primary" style={{ backgroundColor: "#61328C", borderColor: "white" }}>
                  Acquista
                </Button>
              </Form>
            </Card.Body>
